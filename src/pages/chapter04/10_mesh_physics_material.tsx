    ...
    <>
      ...
      <DatGui data={state} onUpdate={setState}>
        ...
        <DatFolder title={material.type} closed={false}>
          ...
          <DatNumber path="clearcoat" min={0} max={1} step={0.01} />
          <DatNumber path="clearcoatRoughness" min={0} max={1} step={0.01} />
          <DatNumber path="reflectivity" min={0} max={1} step={0.01} />
