  ...
  return (
    <>
      ...
      <DatGui data={state} onUpdate={setState}>
        ...
        <DatNumber path="dashSize" min={1} max={100} step={1} />
        <DatNumber path="gapSize" min={1} max={100} step={1} />
        <DatNumber path="scale" min={0.1} max={5} step={0.1} />
      </DatGui>
    </>
  );
};
