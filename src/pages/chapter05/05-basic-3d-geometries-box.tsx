    ...
    <>
      <Canvas
        ...
        <React.Suspense fallback={null}>
          <Scene
            ...
            depthSegments={state.depthSegments}
            material={material}
      ...
      <DatGui
        ...
        <DatFolder title="Folder" closed={false}>
          ...
          />
          <DatNumber path="width" min={1} max={40} step={1} />
          <DatNumber path="height" min={1} max={40} step={1} />
          <DatNumber path="depth" min={1} max={40} step={1} />
          <DatNumber path="widthSegments" min={1} max={40} step={1} />
          <DatNumber path="heightSegments" min={1} max={40} step={1} />
          <DatNumber path="depthSegments" min={1} max={40} step={1} />
