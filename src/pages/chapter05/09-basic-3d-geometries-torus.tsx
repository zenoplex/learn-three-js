    ...
    <>
      ...
      <DatGui
        ...
        <DatFolder title="Folder" closed={false}>
          ...
          <DatNumber path="tube" min={-40} max={40} step={1} />
          <DatNumber path="radialSegments" min={1} max={40} step={1} />
          <DatNumber path="tubularSegments" min={1} max={40} step={1} />
          <DatNumber path="arc" min={0} max={Math.PI * 2} step={0.1} />
