...
const Scene = ({
  ...
  const geometry = React.useMemo(() => {
    const geom = new Three.TorusKnotBufferGeometry(
      radius,
      tube,
      radialSegments,
      tubularSegments,
    ...
    <>
      ...
      <DatGui
        ...
        <DatFolder title="Folder" closed={false}>
          ...
          <DatNumber path="tube" min={0} max={40} step={1} />
          <DatNumber path="radialSegments" min={1} max={400} step={1} />
          <DatNumber path="tubularSegments" min={1} max={400} step={1} />
          <DatNumber path="p" min={0} max={20} step={1} />
          <DatNumber path="q" min={0} max={20} step={1} />
